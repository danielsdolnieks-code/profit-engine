const initial = () => ({common:18000, allocation:'equal', capacity:2000, products:[{name:'Bags',price:50,volume:1000,variable:30,fixed:0,avoidable:0,hours:1,active:true},{name:'Shoes',price:80,volume:0,variable:50,fixed:0,avoidable:0,hours:2,active:true}]});
